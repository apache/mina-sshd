...
reports.each() { file ->
  ...
  if (name.startsWith("japicmp-")) {
    ...
    content = replace(content, "[!CAUTION]", caution_class, caution_img, "Caution")
    content = replace(content, "[!IMPORTANT]", important_class, important_img, "Important")
