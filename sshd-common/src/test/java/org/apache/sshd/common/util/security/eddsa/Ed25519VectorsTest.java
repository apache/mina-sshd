...
class Ed25519VectorsTest extends JUnitTestSupport {
    ...
    static List<Object[]> parameters() {
        ...
        SecurityProviderRegistrar registrar = SecurityUtils.getRegisteredProvider(SecurityUtils.EDDSA);
        if (registrar == null) {
        ...
        parameters.add(new Object[] {
                ...
                "0aab4c900501b3e24d7cdf4663326a3a" + "87df5e4843b2cbdb67cbf6e460fec350" + "aa5371b1508f9f4528ecea23c436d94b"
    ...
    void createPublicKeySpec(
        ...
        assertTrue(SecurityUtils.compareEDDSAPPublicKeys(publicKey, generatedKey), "Generated key is not equal");
    ...
    void createPrivateKeySpec(
        ...
        assertTrue(SecurityUtils.compareEDDSAPrivateKeys(privateKey, generatedKey), "Generated key is not equal");
        byte[] generatedBytes = EdDSAUtils.getBytes(generatedKey);
